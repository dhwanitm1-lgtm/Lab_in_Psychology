...
expName = 'Intentional Binding_exp'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\LAB_IN_PSYCH\\Intentional Binding\\Intentional Binding_exp_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('conditions_intentional binding.xlsx'), 
        seed=None, 
    )
    ...
    # completed 35.0 repeats of 'trials'
