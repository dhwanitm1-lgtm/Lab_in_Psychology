...
expName = 'emotional_valence_experiment'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\LAB_IN_PSYCH\\SOLO PROJECT\\Emotional Picture Memory Task\\emotional_valence_experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='You will see images on the screen.\n\nPress:\nF = Negative\nJ = Positive\n\nTry to respond as fast and correctly as possible.\n\nPress SPACE to begin.',
        font='Arial',
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[polygon, stim, key_resp_2],
        )
        ...
        while continueRoutine:
            ...
            if key_resp_2.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_2_allKeys):
                    ...
                    # was this correct?
                    if (key_resp_2.keys == str('j' if valence=='positive' else 'f')) or (key_resp_2.keys == 'j' if valence=='positive' else 'f'):
                        key_resp_2.corr = 1
                    else:
                        key_resp_2.corr = 0
                    # a response ends the routine
        ...
        if key_resp_2.keys in ['', [], None]:  # No response was made
            ...
            if str('j' if valence=='positive' else 'f').lower() == 'none':
